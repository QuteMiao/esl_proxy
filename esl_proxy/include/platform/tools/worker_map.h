...
/* Multi-SKU compile skeleton (PR #13): pick topology via ESL_PROXY_SKU. */
#ifndef ESL_PROXY_SKU
#define ESL_PROXY_SKU ESL_PROXY_SKU_A2A3
#endif
#define ESL_PROXY_SKU_A2A3 1

#if ESL_PROXY_SKU == ESL_PROXY_SKU_A2A3
#define ESL_PROXY_WORKER_BLOCK_DIM 24
#define ESL_PROXY_AIV_LANES_PER_BLOCK 2
#else
#error "Unsupported ESL_PROXY_SKU; add a topology block for this SKU"
#endif
